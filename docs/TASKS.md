...
- [!] T1.4 M A7 · (everything staged; BLOCKED only on T0.2 token) `substreams run` Pinax erc4626 on Base for a 200-block historical range containing pinned-vault activity. Accept: real Deposit/Withdraw rows. dep: T0.2, T2.2
