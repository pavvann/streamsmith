-- vaultflows.vault_flows
CREATE TABLE vaultflows.vault_flows
(
...
-- vaultflows.share_value_observations
CREATE TABLE vaultflows.share_value_observations
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
...
-- vaultflows.vaults
CREATE TABLE vaultflows.vaults
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
...
-- vaultflows.share_transfers
CREATE TABLE vaultflows.share_transfers
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
