-- vaultflows_hosted.vault_flows
CREATE TABLE vaultflows_hosted.vault_flows
(
...
-- vaultflows_hosted.share_value_observations
CREATE TABLE vaultflows_hosted.share_value_observations
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
...
-- vaultflows_hosted.vaults
CREATE TABLE vaultflows_hosted.vaults
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
...
-- vaultflows_hosted.share_transfers
CREATE TABLE vaultflows_hosted.share_transfers
(
    `_block_number_` UInt64,
    `_block_timestamp_` DateTime,
    `_version_` Int64,
