...
Planning artifacts and the public contract, committed as required by ETHOnline rules for AI-assisted builds.

- `vaultflows.proto` — the public output contract for `erc4626-flows` (frozen before the recorded run)
